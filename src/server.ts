...
app.get("/digipet/feed", (req, res) => {
  ...
  if (getDigipet()) {
    feedDigipet();
    res.json({
      message: "You feed your digipet. It looks happier and healthier now!",
      digipet: getDigipet(),
    });
  } else {
    res.json({
...
app.get("/digipet/train", (req, res) => {
  ...
  if (getDigipet()) {
    trainDigipet();
    res.json({
      message: "You trained your digipet. It looks less happy, but more disciplined. Well done!",
      digipet: getDigipet(),
    });
  } else {
    res.json({
...
app.get("/digipet/ignore", (req, res) => {
  ...
  if (getDigipet()) {
    ignoreDigipet();
    res.json({
      message: "You have ignored your digipet. It is slowly deteriorating",
      digipet: getDigipet(),
    });
  } else {
    res.json({
